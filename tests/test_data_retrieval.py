...
@pytest.fixture()
def mock_data_ingestion(mocker: MockFixture) -> Mock:
    mock = mocker.patch("src.ingestion.data_retrieval.DataIngestion")
    return mock


@pytest.fixture()
def data_retrieval(mock_data_ingestion: Mock) -> DataRetrieval:
